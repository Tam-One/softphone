...
import PageChatGroupInvite from 'pages/PageChatGroupInvite/PageChatGroupInvite'
import PageChatRecents from 'pages/PageChatRecents'
import PageContactPhonebook from 'pages/PageContactPhonebook/PageContactPhonebook'
...
import PageProfileSignIn from 'pages/PageProfileSingIn/PageProfileSignIn'
import PageProfileUpdate from 'pages/PageProfileUpdate'
import PageSettingsDebug from 'pages/PageSettingDebug/PageSettingsDebug'
import PageSettingsOther from 'pages/PageSettingsOther'
import PageSettingsProfile from 'pages/PageSettingsProfile'
import PageTransferDial from 'pages/PageTransferDial/PageTransferDial'
